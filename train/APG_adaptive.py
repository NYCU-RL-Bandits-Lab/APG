...
class APG_adaptive_model(Bellman, Saver):
    ...
    def __init__(self, args: object, logger: object):
        ...
        self.save_path = os.path.join(self.logger.log_dir, 'APG_adaptive', f'mean.parquet')          
    ...
    def learn(self, epoch: int):
        ...
        # log
        self.logger(f"Running adaptive APG...", title=False)
        ...
        for seed in range(self.seed_num):
            ...
            for timestep in pbar:
                ...
                # set pbar
                pbar.set_description(f"[adaptive APG] Epoch {timestep:^10d}/{epoch:^10d}")
                ...
                phi_t = copy.deepcopy(theta_t) + mom_t
                ...
                # print(timestep, epoch)
        
        self.logger(f"Finish running adaptive APG...", title=False)